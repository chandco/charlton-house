...
// Override default WP excerpt properties
...
if( function_exists( 'add_theme_support' ) ) {
    add_theme_support( 'post-thumbnails' );
    set_post_thumbnail_size( 293, 180, true );
}
...
// Example of using the WP add_filter method to override 
// the default content IDs declared in the header 
#add_filter( 'set_content_ids', 'override_content_ids' );
function override_content_ids($test) {
	return array(       
		'cat_fresh_ideas' => 4,
	    'cat_news' => 2,
	    'cat_csr' => 3,
...
function my_custom_login_logo() {
    echo '<style type="text/css">
        ...
        .login h1 a { 
		  background: #fff url('.get_bloginfo('template_directory').'/img/charlton-logo-horizontal.jpg) no-repeat center center !important;
